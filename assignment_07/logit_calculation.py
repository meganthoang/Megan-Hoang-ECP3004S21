...
credit = pd.read_csv('c:/Users/megan/OneDrive/Desktop/credit_data.csv')
...
soln_dfp = minimize(logit_likelihood, beta_0, args=(y, X), method='powell', options = {'xtol': 1e-8, 'maxiter': 1000, 'disp': True})
...
soln_bfgs = minimize(logit_likelihood, beta_0, args=(y, X), method='BFGS', options = {'xtol': 1e-8, 'maxiter': 1000, 'disp': True})
...
soln_ncg_hess = minimize(logit_likelihood, beta_0, args=(y, X), method='Newton-CG', jac = logit_gradient, hess = logit_hessian)
